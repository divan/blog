...
Why is it so? Text is clearly not the best way to represent everything, and all those bright minds working on the visual programming languages were clearly onto something. We definitely are missing something essential to make visual programming a reality.
